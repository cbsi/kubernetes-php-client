...
class ApisApi
{
     ...
     * @return \CBSi\Kubernetes\Model\V1APIGroupList
     */
     ...
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CBSi\Kubernetes\Model\V1APIGroupList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAPIVersionsWithHttpInfo()
    {
        $returnType = '\CBSi\Kubernetes\Model\V1APIGroupList';
        $request = $this->getAPIVersionsRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CBSi\Kubernetes\Model\V1APIGroupList',
    ...
    {
        return $this->getAPIVersionsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function getAPIVersionsRequest()
    {
