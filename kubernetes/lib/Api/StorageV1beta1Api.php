...
/**
 * StorageV1beta1Api Class Doc Comment
 *
 * @category Class
 * @package  CBSi\Kubernetes
 * @author   Swagger Codegen team
...
class StorageV1beta1Api
{
     ...
     *
     * @param  \CBSi\Kubernetes\Model\V1beta1StorageClass $body body (required)
     ...
     * @return \CBSi\Kubernetes\Model\V1beta1StorageClass
     */
     ...
     *
     * @param  \CBSi\Kubernetes\Model\V1beta1StorageClass $body (required)
     * @param  string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
     *
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CBSi\Kubernetes\Model\V1beta1StorageClass, HTTP status code, HTTP response headers (array of strings)
     */
    public function createStorageClassWithHttpInfo($body, $pretty = null)
    {
        $returnType = '\CBSi\Kubernetes\Model\V1beta1StorageClass';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CBSi\Kubernetes\Model\V1beta1StorageClass',
     ...
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CBSi\Kubernetes\Model\V1beta1StorageClassList
     */
     ...
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CBSi\Kubernetes\Model\V1beta1StorageClassList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\CBSi\Kubernetes\Model\V1beta1StorageClassList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CBSi\Kubernetes\Model\V1beta1StorageClassList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
