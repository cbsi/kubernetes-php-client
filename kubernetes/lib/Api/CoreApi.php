...
class CoreApi
{
     ...
     * @return \CBSi\Kubernetes\Model\V1APIVersions
     */
     ...
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CBSi\Kubernetes\Model\V1APIVersions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAPIVersionsWithHttpInfo()
    {
        $returnType = '\CBSi\Kubernetes\Model\V1APIVersions';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CBSi\Kubernetes\Model\V1APIVersions',
