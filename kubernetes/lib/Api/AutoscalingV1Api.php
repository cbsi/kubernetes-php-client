...
/**
 * AutoscalingV1Api Class Doc Comment
 *
 * @category Class
 * @package  CBSi\Kubernetes
 * @author   Swagger Codegen team
...
class AutoscalingV1Api
{
     ...
     * @param  \CBSi\Kubernetes\Model\V1HorizontalPodAutoscaler $body body (required)
     ...
     * @return \CBSi\Kubernetes\Model\V1HorizontalPodAutoscaler
     */
     ...
     *
     * @param  string $namespace object name and auth scope, such as for teams and projects (required)
     * @param  \CBSi\Kubernetes\Model\V1HorizontalPodAutoscaler $body (required)
     * @param  string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
     *
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CBSi\Kubernetes\Model\V1HorizontalPodAutoscaler, HTTP status code, HTTP response headers (array of strings)
     */
    public function createNamespacedHorizontalPodAutoscalerWithHttpInfo($namespace, $body, $pretty = null)
    {
        $returnType = '\CBSi\Kubernetes\Model\V1HorizontalPodAutoscaler';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CBSi\Kubernetes\Model\V1HorizontalPodAutoscaler',
     ...
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CBSi\Kubernetes\Model\V1HorizontalPodAutoscalerList
     */
     ...
     * @throws \CBSi\Kubernetes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CBSi\Kubernetes\Model\V1HorizontalPodAutoscalerList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\CBSi\Kubernetes\Model\V1HorizontalPodAutoscalerList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CBSi\Kubernetes\Model\V1HorizontalPodAutoscalerList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
