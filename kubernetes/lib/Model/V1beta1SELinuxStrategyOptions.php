 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1SELinuxStrategyOptions implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \CBSi\Kubernetes\Model\V1SELinuxOptions $se_linux_options seLinuxOptions required to run as; required for MustRunAs More info: https://git.k8s.io/community/contributors/design-proposals/security_context.md
     *
     * @return $this
     */
