 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1PodDisruptionBudgetList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1PodDisruptionBudget[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1PodDisruptionBudget[] $items items
     *
     * @return $this
     */
