 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1Job implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1JobSpec',
        'status' => '\CBSi\Kubernetes\Model\V1JobStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1JobSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1JobSpec $spec Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1JobStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1JobStatus $status Current status of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
