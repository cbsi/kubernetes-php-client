 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1DaemonSetList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1DaemonSet[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1DaemonSet[] $items A list of daemon sets.
     *
     * @return $this
     */
