 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1CertificateSigningRequestList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1CertificateSigningRequest[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1CertificateSigningRequest[] $items items
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param \CBSi\Kubernetes\Model\V1ListMeta $metadata metadata
     *
     * @return $this
     */
