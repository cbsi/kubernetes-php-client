 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1Node implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1NodeSpec',
        'status' => '\CBSi\Kubernetes\Model\V1NodeStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1NodeSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1NodeSpec $spec Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1NodeStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1NodeStatus $status Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
