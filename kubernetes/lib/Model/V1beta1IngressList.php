 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1IngressList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1Ingress[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1Ingress[] $items Items is the list of Ingress.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param \CBSi\Kubernetes\Model\V1ListMeta $metadata Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
     *
     * @return $this
     */
