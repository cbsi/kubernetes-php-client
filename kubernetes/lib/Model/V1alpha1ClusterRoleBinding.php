...
/**
 * V1alpha1ClusterRoleBinding Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1ClusterRoleBinding implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.ClusterRoleBinding';
     ...
     * Sets role_ref
     *
     * @param \CBSi\Kubernetes\Model\V1alpha1RoleRef $role_ref RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     *
     * @return $this
     */
