 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1Endpoints implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'subsets' => '\CBSi\Kubernetes\Model\V1EndpointSubset[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subsets'] === null) {
            $invalidProperties[] = "'subsets' can't be null";
        }
     ...
     * Gets subsets
     *
     * @return \CBSi\Kubernetes\Model\V1EndpointSubset[]
     */
