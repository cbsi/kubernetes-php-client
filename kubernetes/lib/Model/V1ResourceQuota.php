 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ResourceQuota implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1ResourceQuotaSpec',
        'status' => '\CBSi\Kubernetes\Model\V1ResourceQuotaStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1ResourceQuotaSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1ResourceQuotaSpec $spec Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1ResourceQuotaStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1ResourceQuotaStatus $status Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
