 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1NodeCondition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \DateTime $last_heartbeat_time Last time we got an update on a given condition.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $last_transition_time Last time the condition transit from one status to another.
     *
     * @return $this
     */
