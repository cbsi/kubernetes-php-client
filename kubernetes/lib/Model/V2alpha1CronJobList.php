 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1CronJobList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V2alpha1CronJob[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V2alpha1CronJob[] $items items is the list of CronJobs.
     *
     * @return $this
     */
