 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ComponentStatusList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1ComponentStatus[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1ComponentStatus[] $items List of ComponentStatus objects.
     *
     * @return $this
     */
