 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ClusterRoleBinding implements ModelInterface, ArrayAccess
{
     ...
     * Sets role_ref
     *
     * @param \CBSi\Kubernetes\Model\V1beta1RoleRef $role_ref RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     *
     * @return $this
     */
