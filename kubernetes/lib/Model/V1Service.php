...
class V1Service implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1ServiceSpec',
        'status' => '\CBSi\Kubernetes\Model\V1ServiceStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1ServiceSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1ServiceSpec $spec Spec defines the behavior of a service. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1ServiceStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1ServiceStatus $status Most recently observed status of the service. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
