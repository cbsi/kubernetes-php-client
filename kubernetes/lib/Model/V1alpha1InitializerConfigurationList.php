...
/**
 * V1alpha1InitializerConfigurationList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1InitializerConfigurationList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.InitializerConfigurationList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1alpha1InitializerConfiguration[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1alpha1InitializerConfiguration[] $items List of InitializerConfiguration.
     *
     * @return $this
     */
