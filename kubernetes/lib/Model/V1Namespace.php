 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1Namespace implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1NamespaceSpec',
        'status' => '\CBSi\Kubernetes\Model\V1NamespaceStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1NamespaceSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1NamespaceSpec $spec Spec defines the behavior of the Namespace. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1NamespaceStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1NamespaceStatus $status Status describes the current status of a Namespace. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
