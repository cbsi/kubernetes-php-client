 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1RoleBinding implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'role_ref' => '\CBSi\Kubernetes\Model\V1beta1RoleRef',
        'subjects' => '\CBSi\Kubernetes\Model\V1beta1Subject[]'
    ];
     ...
     * Gets role_ref
     *
     * @return \CBSi\Kubernetes\Model\V1beta1RoleRef
     */
     ...
     * Sets role_ref
     *
     * @param \CBSi\Kubernetes\Model\V1beta1RoleRef $role_ref RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
     *
     * @return $this
     */
     ...
     * Gets subjects
     *
     * @return \CBSi\Kubernetes\Model\V1beta1Subject[]
     */
     ...
     * Sets subjects
     *
     * @param \CBSi\Kubernetes\Model\V1beta1Subject[] $subjects Subjects holds references to the objects the role applies to.
     *
     * @return $this
     */
