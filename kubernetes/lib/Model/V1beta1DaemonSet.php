 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1DaemonSet implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1beta1DaemonSetSpec',
        'status' => '\CBSi\Kubernetes\Model\V1beta1DaemonSetStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1beta1DaemonSetSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1beta1DaemonSetSpec $spec The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1beta1DaemonSetStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1beta1DaemonSetStatus $status The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
