 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1APIGroup implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'kind' => 'string',
        'name' => 'string',
        'preferred_version' => '\CBSi\Kubernetes\Model\V1GroupVersionForDiscovery',
        'server_address_by_client_cid_rs' => '\CBSi\Kubernetes\Model\V1ServerAddressByClientCIDR[]',
        'versions' => '\CBSi\Kubernetes\Model\V1GroupVersionForDiscovery[]'
    ];
     ...
     *
     * @return \CBSi\Kubernetes\Model\V1GroupVersionForDiscovery
     */
     ...
     *
     * @param \CBSi\Kubernetes\Model\V1GroupVersionForDiscovery $preferred_version preferredVersion is the version preferred by the API server, which probably is the storage version.
     *
     * @return $this
     */
     ...
     * Sets versions
     *
     * @param \CBSi\Kubernetes\Model\V1GroupVersionForDiscovery[] $versions versions are the versions supported in this group.
     *
     * @return $this
     */
