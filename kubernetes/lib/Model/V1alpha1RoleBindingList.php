...
/**
 * V1alpha1RoleBindingList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1RoleBindingList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.RoleBindingList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1alpha1RoleBinding[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1alpha1RoleBinding[] $items Items is a list of RoleBindings
     *
     * @return $this
     */
