...
/**
 * V1NetworkPolicyList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1NetworkPolicyList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1.NetworkPolicyList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1NetworkPolicy[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1NetworkPolicy[] $items Items is a list of schema objects.
     *
     * @return $this
     */
