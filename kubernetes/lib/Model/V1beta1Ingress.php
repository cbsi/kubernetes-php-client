 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1Ingress implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1beta1IngressSpec',
        'status' => '\CBSi\Kubernetes\Model\V1beta1IngressStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1beta1IngressSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1beta1IngressSpec $spec Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1beta1IngressStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1beta1IngressStatus $status Status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
