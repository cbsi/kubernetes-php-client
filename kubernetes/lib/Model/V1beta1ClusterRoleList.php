 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ClusterRoleList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1ClusterRole[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1ClusterRole[] $items Items is a list of ClusterRoles
     *
     * @return $this
     */
