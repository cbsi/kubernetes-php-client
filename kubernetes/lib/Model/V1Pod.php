 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1Pod implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1PodSpec',
        'status' => '\CBSi\Kubernetes\Model\V1PodStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1PodSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1PodSpec $spec Specification of the desired behavior of the pod. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1PodStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1PodStatus $status Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
