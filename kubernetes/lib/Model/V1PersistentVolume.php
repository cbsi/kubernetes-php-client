 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1PersistentVolume implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V1PersistentVolumeSpec',
        'status' => '\CBSi\Kubernetes\Model\V1PersistentVolumeStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V1PersistentVolumeSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V1PersistentVolumeSpec $spec Spec defines a specification of a persistent volume owned by the cluster. Provisioned by an administrator. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V1PersistentVolumeStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V1PersistentVolumeStatus $status Status represents the current information/status for the persistent volume. Populated by the system. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
     *
     * @return $this
     */
