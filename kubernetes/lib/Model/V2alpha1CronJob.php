 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1CronJob implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'spec' => '\CBSi\Kubernetes\Model\V2alpha1CronJobSpec',
        'status' => '\CBSi\Kubernetes\Model\V2alpha1CronJobStatus'
    ];
     ...
     * Gets spec
     *
     * @return \CBSi\Kubernetes\Model\V2alpha1CronJobSpec
     */
     ...
     * Sets spec
     *
     * @param \CBSi\Kubernetes\Model\V2alpha1CronJobSpec $spec Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \CBSi\Kubernetes\Model\V2alpha1CronJobStatus
     */
     ...
     * Sets status
     *
     * @param \CBSi\Kubernetes\Model\V2alpha1CronJobStatus $status Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status
     *
     * @return $this
     */
