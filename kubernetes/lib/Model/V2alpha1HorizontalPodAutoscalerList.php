 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1HorizontalPodAutoscalerList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V2alpha1HorizontalPodAutoscaler[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V2alpha1HorizontalPodAutoscaler[] $items items is the list of horizontal pod autoscaler objects.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param \CBSi\Kubernetes\Model\V1ListMeta $metadata metadata is the standard list metadata.
     *
     * @return $this
     */
