 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1CronJobStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'active' => '\CBSi\Kubernetes\Model\V1ObjectReference[]',
     ...
     * Sets active
     *
     * @param \CBSi\Kubernetes\Model\V1ObjectReference[] $active A list of pointers to currently running jobs.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $last_schedule_time Information when was the last time the job was successfully scheduled.
     *
     * @return $this
     */
