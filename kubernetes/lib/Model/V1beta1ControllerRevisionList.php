...
/**
 * V1beta1ControllerRevisionList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ControllerRevisionList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1beta1.ControllerRevisionList';
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1ControllerRevision[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1ControllerRevision[] $items Items is the list of ControllerRevisions
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param \CBSi\Kubernetes\Model\V1ListMeta $metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
     *
     * @return $this
     */
