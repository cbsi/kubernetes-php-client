 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1beta1ReplicaSetList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1beta1ReplicaSet[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1beta1ReplicaSet[] $items List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
     *
     * @return $this
     */
