 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ServiceAccount implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'secrets' => '\CBSi\Kubernetes\Model\V1ObjectReference[]'
    ];
     ...
     *
     * @param \CBSi\Kubernetes\Model\V1LocalObjectReference[] $image_pull_secrets ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images in pods that reference this ServiceAccount. ImagePullSecrets are distinct from Secrets because Secrets can be mounted in the pod, but ImagePullSecrets are only accessed by the kubelet. More info: https://kubernetes.io/docs/concepts/containers/images/#specifying-imagepullsecrets-on-a-pod
     *
     * @return $this
     */
     ...
     * Sets secrets
     *
     * @param \CBSi\Kubernetes\Model\V1ObjectReference[] $secrets Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. More info: https://kubernetes.io/docs/concepts/configuration/secret
     *
     * @return $this
     */
