...
/**
 * V1alpha1RoleRef Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1RoleRef implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1alpha1.RoleRef';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['api_group'] === null) {
            $invalidProperties[] = "'api_group' can't be null";
        }
