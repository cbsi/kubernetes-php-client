 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1alpha1PodPresetList implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'api_version' => 'string',
        'items' => '\CBSi\Kubernetes\Model\V1alpha1PodPreset[]',
        'kind' => 'string',
     ...
     * Sets items
     *
     * @param \CBSi\Kubernetes\Model\V1alpha1PodPreset[] $items Items is a list of schema objects.
     *
     * @return $this
     */
