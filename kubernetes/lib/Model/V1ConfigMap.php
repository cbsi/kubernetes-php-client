 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ConfigMap implements ModelInterface, ArrayAccess
{
     ...
     * Sets data
     *
     * @param map[string,string] $data Data contains the configuration data. Each key must consist of alphanumeric characters, '-', '_' or '.'.
     *
     * @return $this
     */
