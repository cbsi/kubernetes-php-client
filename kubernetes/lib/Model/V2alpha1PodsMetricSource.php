 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2alpha1PodsMetricSource implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['target_average_value'] === null) {
            $invalidProperties[] = "'target_average_value' can't be null";
        }
     ...
     *
     * @param string $target_average_value targetAverageValue is the target value of the average of the metric across all relevant pods (as a quantity)
     *
     * @return $this
     */
