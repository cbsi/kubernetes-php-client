...
------------ | ------------- | ------------- | -------------
**field_ref** | [**\CBSi\Kubernetes\Model\V1ObjectFieldSelector**](V1ObjectFieldSelector.md) | Required: Selects a field of the pod: only annotations, labels, name and namespace are supported. | [optional] 
