...
**conditions** | [**\CBSi\Kubernetes\Model\V1beta1ReplicaSetCondition[]**](V1beta1ReplicaSetCondition.md) | Represents the latest available observations of a replica set&#39;s current state. | [optional] 
