# CBSi\Kubernetes\ApiregistrationV1beta1Api
...
[**\CBSi\Kubernetes\Model\V1beta1APIServiceList**](../Model/V1beta1APIServiceList.md)
...
# **patchAPIService**
> \CBSi\Kubernetes\Model\V1beta1APIService patchAPIService($name, $body, $pretty)
...
try {
    $result = $api_instance->patchAPIService($name, $body, $pretty);
    print_r($result);
} catch (Exception $e) {
