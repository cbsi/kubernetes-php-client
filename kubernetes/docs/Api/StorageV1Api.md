...
try {
    ...
    echo 'Exception when calling StorageV1Api->deleteCollectionStorageClass: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CBSi\Kubernetes\Model\V1StorageClassList**](../Model/V1StorageClassList.md)
...
# **patchStorageClass**
> \CBSi\Kubernetes\Model\V1StorageClass patchStorageClass($name, $body, $pretty)
