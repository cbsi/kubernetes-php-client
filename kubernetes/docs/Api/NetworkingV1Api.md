# CBSi\Kubernetes\NetworkingV1Api
...
> \CBSi\Kubernetes\Model\V1NetworkPolicy createNamespacedNetworkPolicy($namespace, $body, $pretty)
...
$api_instance = new CBSi\Kubernetes\Api\NetworkingV1Api(new \Http\Adapter\Guzzle6\Client());
$namespace = "namespace_example"; // string | object name and auth scope, such as for teams and projects
$body = new \CBSi\Kubernetes\Model\V1NetworkPolicy(); // \CBSi\Kubernetes\Model\V1NetworkPolicy | 
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->createNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **body** | [**\CBSi\Kubernetes\Model\V1NetworkPolicy**](../Model/V1NetworkPolicy.md)|  |
 **pretty** | **string**| If &#39;true&#39;, then the output is pretty printed. | [optional]

### Return type

[**\CBSi\Kubernetes\Model\V1NetworkPolicy**](../Model/V1NetworkPolicy.md)
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->deleteCollectionNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->deleteNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->getAPIResources: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \CBSi\Kubernetes\Model\V1NetworkPolicyList listNamespacedNetworkPolicy($namespace, $pretty, $field_selector, $include_uninitialized, $label_selector, $resource_version, $timeout_seconds, $watch)
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->listNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CBSi\Kubernetes\Model\V1NetworkPolicyList**](../Model/V1NetworkPolicyList.md)
...
> \CBSi\Kubernetes\Model\V1NetworkPolicyList listNetworkPolicyForAllNamespaces($field_selector, $include_uninitialized, $label_selector, $pretty, $resource_version, $timeout_seconds, $watch)
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->listNetworkPolicyForAllNamespaces: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \CBSi\Kubernetes\Model\V1NetworkPolicy patchNamespacedNetworkPolicy($name, $namespace, $body, $pretty)
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->patchNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \CBSi\Kubernetes\Model\V1NetworkPolicy readNamespacedNetworkPolicy($name, $namespace, $pretty, $exact, $export)
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->readNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \CBSi\Kubernetes\Model\V1NetworkPolicy replaceNamespacedNetworkPolicy($name, $namespace, $body, $pretty)
...
try {
    ...
    echo 'Exception when calling NetworkingV1Api->replaceNamespacedNetworkPolicy: ', $e->getMessage(), PHP_EOL;
}
?>
```
