...
# **createNamespacedJob**
> \CBSi\Kubernetes\Model\V1Job createNamespacedJob($namespace, $body, $pretty)
...
$api_instance = new CBSi\Kubernetes\Api\BatchV1Api(new \Http\Adapter\Guzzle6\Client());
$namespace = "namespace_example"; // string | object name and auth scope, such as for teams and projects
$body = new \CBSi\Kubernetes\Model\V1Job(); // \CBSi\Kubernetes\Model\V1Job | 
$pretty = "pretty_example"; // string | If 'true', then the output is pretty printed.

try {
    $result = $api_instance->createNamespacedJob($namespace, $body, $pretty);
    print_r($result);
} catch (Exception $e) {
 ...
 **body** | [**\CBSi\Kubernetes\Model\V1Job**](../Model/V1Job.md)|  |
 **pretty** | **string**| If &#39;true&#39;, then the output is pretty printed. | [optional]

### Return type

[**\CBSi\Kubernetes\Model\V1Job**](../Model/V1Job.md)
...
> \CBSi\Kubernetes\Model\V1Status deleteCollectionNamespacedJob($namespace, $pretty, $field_selector, $include_uninitialized, $label_selector, $resource_version, $timeout_seconds, $watch)
...
try {
    $result = $api_instance->deleteCollectionNamespacedJob($namespace, $pretty, $field_selector, $include_uninitialized, $label_selector, $resource_version, $timeout_seconds, $watch);
    print_r($result);
} catch (Exception $e) {
...
# **deleteNamespacedJob**
> \CBSi\Kubernetes\Model\V1Status deleteNamespacedJob($name, $namespace, $body, $pretty, $grace_period_seconds, $orphan_dependents, $propagation_policy)
...
try {
    $result = $api_instance->deleteNamespacedJob($name, $namespace, $body, $pretty, $grace_period_seconds, $orphan_dependents, $propagation_policy);
    print_r($result);
} catch (Exception $e) {
...
> \CBSi\Kubernetes\Model\V1JobList listJobForAllNamespaces($field_selector, $include_uninitialized, $label_selector, $pretty, $resource_version, $timeout_seconds, $watch)
...
try {
    $result = $api_instance->listJobForAllNamespaces($field_selector, $include_uninitialized, $label_selector, $pretty, $resource_version, $timeout_seconds, $watch);
    print_r($result);
} catch (Exception $e) {
...
[**\CBSi\Kubernetes\Model\V1JobList**](../Model/V1JobList.md)
...
# **listNamespacedJob**
> \CBSi\Kubernetes\Model\V1JobList listNamespacedJob($namespace, $pretty, $field_selector, $include_uninitialized, $label_selector, $resource_version, $timeout_seconds, $watch)
...
try {
    $result = $api_instance->listNamespacedJob($namespace, $pretty, $field_selector, $include_uninitialized, $label_selector, $resource_version, $timeout_seconds, $watch);
    print_r($result);
} catch (Exception $e) {
...
# **patchNamespacedJob**
> \CBSi\Kubernetes\Model\V1Job patchNamespacedJob($name, $namespace, $body, $pretty)
...
try {
    $result = $api_instance->patchNamespacedJob($name, $namespace, $body, $pretty);
    print_r($result);
} catch (Exception $e) {
...
> \CBSi\Kubernetes\Model\V1Job patchNamespacedJobStatus($name, $namespace, $body, $pretty)
...
try {
    $result = $api_instance->patchNamespacedJobStatus($name, $namespace, $body, $pretty);
    print_r($result);
} catch (Exception $e) {
...
# **readNamespacedJob**
> \CBSi\Kubernetes\Model\V1Job readNamespacedJob($name, $namespace, $pretty, $exact, $export)
...
try {
    $result = $api_instance->readNamespacedJob($name, $namespace, $pretty, $exact, $export);
    print_r($result);
} catch (Exception $e) {
...
> \CBSi\Kubernetes\Model\V1Job readNamespacedJobStatus($name, $namespace, $pretty)
...
try {
    $result = $api_instance->readNamespacedJobStatus($name, $namespace, $pretty);
    print_r($result);
} catch (Exception $e) {
...
> \CBSi\Kubernetes\Model\V1Job replaceNamespacedJob($name, $namespace, $body, $pretty)
...
try {
    $result = $api_instance->replaceNamespacedJob($name, $namespace, $body, $pretty);
    print_r($result);
} catch (Exception $e) {
...
> \CBSi\Kubernetes\Model\V1Job replaceNamespacedJobStatus($name, $namespace, $body, $pretty)
...
try {
    $result = $api_instance->replaceNamespacedJobStatus($name, $namespace, $body, $pretty);
    print_r($result);
} catch (Exception $e) {
