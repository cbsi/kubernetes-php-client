# CBSi\Kubernetes\AuthenticationV1Api
...
# **createTokenReview**
> \CBSi\Kubernetes\Model\V1TokenReview createTokenReview($body, $pretty)
...
$api_instance = new CBSi\Kubernetes\Api\AuthenticationV1Api(new \Http\Adapter\Guzzle6\Client());
$body = new \CBSi\Kubernetes\Model\V1TokenReview(); // \CBSi\Kubernetes\Model\V1TokenReview | 
...
try {
    ...
    echo 'Exception when calling AuthenticationV1Api->createTokenReview: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\CBSi\Kubernetes\Model\V1TokenReview**](../Model/V1TokenReview.md)|  |
 **pretty** | **string**| If &#39;true&#39;, then the output is pretty printed. | [optional]

### Return type

[**\CBSi\Kubernetes\Model\V1TokenReview**](../Model/V1TokenReview.md)
...
try {
    ...
    echo 'Exception when calling AuthenticationV1Api->getAPIResources: ', $e->getMessage(), PHP_EOL;
}
?>
```
